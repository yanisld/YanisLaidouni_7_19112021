<template>
  <div class="login-page">
    ...
    <form @submit.prevent="login" id="login-form" class="login-form">
      <input class="login-form_input" type="email" name="email" placeholder="Adresse Email" required />
      <input class="login-form_input" type="password" name="password" placeholder="Mot de passe" required />
